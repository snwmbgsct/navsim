...
echo "File openscene_metadata_test.tgz successfully downloaded" >> log.txt
...
for split in {0..31}; do
    ...
    echo "File openscene_sensor_test_camera_${split}.tgz successfully downloaded and extracted" >> log.txt
...
for split in {0..31}; do
    ...
    echo "File openscene_sensor_test_lidar_${split}.tgz successfully downloaded and extracted" >> log.txt
