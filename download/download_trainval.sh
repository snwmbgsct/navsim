...
echo "File openscene_metadata_trainval.tgz successfully downloaded" >> log.txt
...
for split in {0..199}; do
    ...
    echo "File openscene_sensor_trainval_camera_${split}.tgz successfully downloaded and extracted" >> log.txt
...
for split in {0..199}; do
    ...
    echo "File openscene_sensor_trainval_lidar_${split}.tgz successfully downloaded and extracted" >> log.txt
